    ...
    <div className="min-h-screen bg-hero text-white flex flex-col">
      ...
      <div className="px-6 pt-14 pb-10 relative overflow-hidden">
        ...
        <div className="relative">
          <div className="h-12 w-12 rounded-2xl bg-white/20 backdrop-blur grid place-items-center font-extrabold text-xl shadow-qa">P</div>
          <h1 className="mt-5 text-[26px] font-extrabold leading-tight">POCER Agen</h1>
          <p className="text-white/85 text-[14px] mt-1">
            POCER — masuk untuk menjual voucher.
          </p>
        </div>
      </div>
