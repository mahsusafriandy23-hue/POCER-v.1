...
export function Badge({
  ...
  const tones: Record<string, string> = {
    ...
    warn: "bg-amber-950/50 text-amber-400",
    danger: "bg-rose-950/50 text-rose-400",
...
export function Card({
  ...
  return (
    <Tag className={`rounded-3xl bg-surface border border-line ${className}`} {...rest}>
      {children}
    </Tag>
  );
}
...
export const Select = forwardRef<HTMLSelectElement, SelectProps>(function Select(
  ...
  return (
    <label className="block">
      ...
      <div className="rounded-2xl bg-surface border border-line px-3 focus-within:border-azure focus-within:ring-2 focus-within:ring-azure/20 transition-all">
        <select
          ref={ref}
