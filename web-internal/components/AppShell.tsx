...
const OWNER_NAV: NavItem[] = [
  { href: "/owner", label: "Dashboard", icon: GridIcon },
  { href: "/owner/agen", label: "Agen", icon: UsersIcon },
  { href: "/owner/paket", label: "Paket", icon: TagIcon },
  { href: "/owner/pelanggan", label: "Pelanggan", icon: WalletIcon },
  { href: "/owner/akun", label: "Akun", icon: UserIcon },
];

const AGENT_NAV: NavItem[] = [
  { href: "/agen", label: "Beranda", icon: GridIcon },
  { href: "/agen/jual", label: "Jual", icon: BoltIcon },
  { href: "/agen/saldo", label: "Saldo", icon: WalletIcon },
  { href: "/agen/riwayat", label: "Riwayat", icon: ReceiptIcon },
...
export function AppShell({ role, children }: { role: Role; children: ReactNode }) {
  ...
  const nav = role === "owner" ? OWNER_NAV : AGENT_NAV;
  ...
  return (
    <div className="min-h-screen bg-stage md:flex">
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <main className="flex-1 px-4 md:px-8 py-5 md:py-8 pb-24 md:pb-8 w-full max-w-3xl mx-auto">{children}</main>
      </div>
